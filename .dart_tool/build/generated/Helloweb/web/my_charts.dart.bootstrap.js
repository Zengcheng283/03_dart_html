...
let modulePaths = {
 ...
 "web/my_charts": "my_charts.sound.ddc"
};
if(!window.$dartLoader) {
   window.$dartLoader = {
     appDigests: _currentDirectory + 'my_charts.digests',
...
define("my_charts.dart.bootstrap", ["web/my_charts", "dart_sdk"], function(app, dart_sdk) {
  ...
  (app.web__my_charts || app.my_charts).main();
  var bootstrap = {
  ...
  dart_sdk.dart.trackLibraries("my_charts.dart.bootstrap", {
    "my_charts.dart.bootstrap": bootstrap
  }, '');
  return {
    bootstrap: bootstrap
  };
