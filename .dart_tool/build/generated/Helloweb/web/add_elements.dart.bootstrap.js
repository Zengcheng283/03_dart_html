...
let modulePaths = {
 ...
 "web/add_elements": "add_elements.sound.ddc"
};
if(!window.$dartLoader) {
   window.$dartLoader = {
     appDigests: _currentDirectory + 'add_elements.digests',
...
define("add_elements.dart.bootstrap", ["web/add_elements", "dart_sdk"], function(app, dart_sdk) {
  ...
  (app.web__add_elements || app.add_elements).main();
  var bootstrap = {
      hot$onChildUpdate: function(childName, child) {
        ...
        if (childName === "add_elements.dart") {
          // Clear static caches.
  ...
  dart_sdk.dart.trackLibraries("add_elements.dart.bootstrap", {
    "add_elements.dart.bootstrap": bootstrap
  }, '');
  return {
    bootstrap: bootstrap
  };
