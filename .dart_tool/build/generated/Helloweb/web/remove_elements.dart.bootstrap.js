...
let modulePaths = {
 ...
 "web/remove_elements": "remove_elements.sound.ddc"
};
if(!window.$dartLoader) {
   window.$dartLoader = {
     appDigests: _currentDirectory + 'remove_elements.digests',
...
define("remove_elements.dart.bootstrap", ["web/remove_elements", "dart_sdk"], function(app, dart_sdk) {
  ...
  (app.web__remove_elements || app.remove_elements).main();
  var bootstrap = {
      hot$onChildUpdate: function(childName, child) {
        ...
        if (childName === "remove_elements.dart") {
          // Clear static caches.
  ...
  dart_sdk.dart.trackLibraries("remove_elements.dart.bootstrap", {
    "remove_elements.dart.bootstrap": bootstrap
  }, '');
  return {
    bootstrap: bootstrap
  };
