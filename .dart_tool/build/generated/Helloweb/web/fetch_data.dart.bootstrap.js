...
let modulePaths = {
 ...
 "web/fetch_data": "fetch_data.sound.ddc"
};
if(!window.$dartLoader) {
   window.$dartLoader = {
     appDigests: _currentDirectory + 'fetch_data.digests',
...
define("fetch_data.dart.bootstrap", ["web/fetch_data", "dart_sdk"], function(app, dart_sdk) {
  ...
  (app.web__fetch_data || app.fetch_data).main();
  var bootstrap = {
  ...
  dart_sdk.dart.trackLibraries("fetch_data.dart.bootstrap", {
    "fetch_data.dart.bootstrap": bootstrap
  }, '');
  return {
    bootstrap: bootstrap
  };
